...
namespace UnrealLocres
{
    class Program
    {
        ...
        class ExportOptions
        {
            ...
            [Option('f', "format", Default = "csv", HelpText = "Output format [pot, csv, txt]")]
        ...
        class ImportOptions
        {
            ...
            [Option('f', "format", Default = "csv", HelpText = "Translation file input format [pot, csv, txt]")]
        ...
        {
            RegisterConverter(new TxtConverter());
